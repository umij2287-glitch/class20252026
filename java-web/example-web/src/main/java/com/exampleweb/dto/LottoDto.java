...
public class LottoDto { // 데이터베이스에 로또 테이블의 데이터를 저장하는 DTO 클래스.
	
	private int rnd;
	public static SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd"); // 인스턴스에 관계없이 모두 사용하도록 static.
				// 날짜->특정 형식 문자열 or 특정 형식 문자열 -> 날짜
