...
<div id="header" style="background-color:${not empty param.bgcolor ? param.bgcolor : ''}">    	
	...
	<div class="title">
	        <a href="/springdemoweb4/home">DEMO WEBSITE</a>
	</div>
	...
	<!-- if -->
		...
		<c:if test="${loginuser == null}">
			<a href="/springdemoweb4/account/login">로그인</a>
		    <a href="/springdemoweb4/account/register">회원가입</a>
		</c:if>
		<c:if test="${loginuser != null}">
			...
			${sessionScope.loginuser.getMemberId()}(${sessionScope.loginuser.getEmail()}) 명시적으로 찾아올 곳 지정
	   		<a href="/springdemoweb4/account/logout">로그아웃</a>
		</c:if>
		--%>
 ...
 <div id="menu">
       <div>
           <ul>
               	<li><a href="/springdemoweb4/admin/user">사용자관리</a></li>
				<li><a href="/springdemoweb4/mail/list">메일보내기</a></li>
				<li><a href="/springdemoweb4/library/list">자료실</a></li>
				<li><a href="/springdemoweb4/board/list">게시판</a></li>
           </ul>
       </div>
</div>
