...
<head>
	...
	<link rel='Stylesheet' href='/springdemoweb99/resources/styles/input.css' />
</head>
<body>
	...
	<div id='pageContainer'>
		...
		<div id="inputcontent">
		    ...
		    <div id="inputmain">
		        ...
		        <!-- <form action="/springdemoweb99/account/login" method="post"> --> <!-- 브라우저 주소 ? 절대 경로 -->
	...
	$(function() {
		...
		$('#cancel-btn').on("click", function(event) {
			location.href = "/springdemoweb99/home";
		});
	
		$('#reset-pwd-btn').on("click", function(event) {
			location.href = "/springdemoweb99/account/reset-passwd";
		});
