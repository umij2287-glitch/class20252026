...
<div id="header" style="background-color:${not empty param.bgcolor ? param.bgcolor : ''}">    	
	...
	<div class="title">
	        <a href="/springdemoweb99/home">DEMO WEBSITE</a>
	</div>
	...
	<!-- if -->
		...
		<c:if test="${loginuser == null}">
			<a href="/springdemoweb99/account/login">로그인</a>
		    <a href="/springdemoweb99/account/register">회원가입</a>
		</c:if>
		<c:if test="${loginuser != null}">
			...
			${sessionScope.loginuser.getMemberId()}(${sessionScope.loginuser.getEmail()}) 명시적으로 찾아올 곳 지정
	   		<a href="/springdemoweb99/account/logout">로그아웃</a>
		</c:if>
		--%>
 ...
 <div id="menu">
       <div>
           <ul>
               	<li><a href="/springdemoweb99/admin/user">사용자관리</a></li>
				<li><a href="/springdemoweb99/mail/list">메일보내기</a></li>
				<li><a href="/springdemoweb99/library/list">자료실</a></li>
				<li><a href="/springdemoweb99/board/list">게시판</a></li>
           </ul>
       </div>
</div>
