	...
	<div id="pageContainer">
		...
		<div id="inputcontent">
		    <div id="inputmain">
		        ...
		        <!-- form 시작 -->
		        <form action="/springdemoweb99/board/edit" method="post" enctype="multipart/form-data">		        
	...
	<script type="text/javascript">
		$(function() {
			$('#btn-cancel').on('click', function(event) {
				location.href = '/springdemoweb99/board/detail?boardNo=${ board.boardNo }&pageNo=${ pageNo }';
			});
			$(".delete-attach").on("click", event => {
				const attachNo = $(event.target).attr("data-attachNo")
				// fetch("/springdemoweb99/board/delete-attach?attachNo=" + attachNo)
				fetch("/springdemoweb99/board/delete-attach/" + attachNo)
