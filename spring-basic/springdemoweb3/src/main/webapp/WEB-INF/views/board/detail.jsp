...
<head>
	...
	<link rel="Stylesheet" href="/springdemoweb3/resources/styles/input2.css" />
</head>
<body>
		            ...
		            <tr>
		                ...
		                <td>
		                	<c:forEach var="attachment" items="${ board.attachments }">
			                	<a href="/springdemoweb3/board/download/${ attachment.attachNo }">
...
$( () => {
	...
	$("#tolist_button").on("click", (e) => {
		location.href = "/springdemoweb3/board/list?pageNo=${ pageNo }";
	})
	...
	$("#delete_button").on("click", (e) => {
    	...
    	//location.href = "/springdemoweb3/board/delete?boardNo=${board.boardNo}?pageNo=${pageNo}"
		location.href = "/springdemoweb3/board/delete/${board.boardNo}?pageNo=${pageNo}";
   	})
   	
   	$("#edit_button").on("click", (e) => {
		
    	//location.href = "/springdemoweb3/board/edit?boardNo=${board.boardNo}?pageNo=${pageNo}"
		location.href = "/springdemoweb3/board/edit/${board.boardNo}?pageNo=${pageNo}";
   	})
