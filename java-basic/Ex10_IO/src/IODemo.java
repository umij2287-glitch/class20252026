...
//		istream2.close();
		...
		// binary 데이터 쓰기
//		FileOutputStream ostream3 = new FileOutputStream("test3.dat");//파일에 쓰기 -> text 에 비해 용량 적음.
...
//		istream4.close();
		...
		//5. Object <-> byte[]	
//		ArrayList<Item> items = new ArrayList<Item>(); // Arraylist : Serializable -> items 도 가능해짐.
//		for (int i = 0; i < 10; i++) {
//			Item item = new Item();
//			item.setNo(i+1); 
